...
## Algorithm
1. Prepare the dataset with student features and placement status, then split into input (X) and target (y).
2.Split the data into training and testing sets and scale the feature values.
3.Create and train the Logistic Regression model using the training data.
4.Predict placement status for test/new data and display accuracy and results
...
<img width="1348" height="409" alt="image" src="https://github.com/user-attachments/assets/a16d9640-e9b5-4610-8782-9bcb6b60b14e" />
